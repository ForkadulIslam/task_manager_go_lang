<template>
  <div class="absolute right-0 z-20 w-64 mt-2 overflow-hidden bg-white rounded-md shadow-lg sm:w-80 dark:bg-gray-800">
    <div class="py-2">
      ...
      <a v-for="notification in notifications" :key="notification.id" href="#" @click.prevent="handleNotificationClick(notification)" class="flex items-center px-4 py-3 -mx-2 border-b hover:bg-gray-100 dark:hover:bg-gray-700 dark:border-gray-700">
        <div class="mx-3">
